...
class FogScene {
    ...
    init() {
        ...
        let planeMaterial = new three_2.MeshBasicMaterial({ color: '#e6a67a' });
        this.plane = new three_2.Mesh(planeGeometry, planeMaterial);
        ...
        this.fog = new FogGfx_1.FogGfx(new three_2.Color().setHex(+props.outerColor.replace('#', '0x')).getHex(), props.numberOfSprites, props.height, props.width, props.depth);
    ...
    mouseMoveFog(movementProp) {
        // Raycaster
        this.raycaster = new three_2.Raycaster();
        this.pointer = new three_2.Vector2();
...
class FogMaterial extends three_7.ShaderMaterial {
    constructor() {
        ...
        this.uniforms = {
            ...
            uOpacity: { value: 0.9 },
            uInnerColor: { value: new three_7.Color(0xFFCE00) }
        };
    }
}
